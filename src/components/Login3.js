      ...
      validateField(fieldName, value) {
        ...
        switch(fieldName) {
          ...
          case 'password':
            ...
            if(passwordValid = value.match(/^(?=.*[A-Z ])*$/))
            {
              this.setState({
                tick1: 'true'
              })
            ...
            else if(passwordValid = value.match(/^[0-9]*$/))
            {
          ...
          else if(passwordValid = value.match("(?=.*[!@#$%^&*])"))
            {
            ...
            else if(passwordValid = value.match(/^.{6,}/))
            {
                       ...
                       />
                        <p className="passn"> 
                          <ul>
                            ...
                            <li>Atleast one capital letter- {this.state.tick1}</li>
                            <li>Atleast one number- {this.state.tick2}</li>
                            <li>Atleast one special character- {this.state.tick3}</li>
                            <li> six Characters Minimum- {this.state.tick4}</li>
